...
pub fn create_zktube_recursive_aggregate(
    tree_depth: usize,
    num_inputs: usize,
...
pub fn proof_recursive_aggregate_for_zktube<'a>(
    tree_depth: usize,
    num_inputs: usize,
    all_known_vks: &[VerificationKey<Bn256, OldActualParams>],
    proofs: &[Proof<Bn256, OldActualParams>],
...
mod test {
    ...
    fn simulate_zktube_proofs() {
        ...
        let proof = proof_recursive_aggregate_for_zktube(
            tree_depth, 
            num_inputs, 
            &vks, 
            &proofs, 
    ...
    fn simulate_many_proofs() {
        ...
        let _ = proof_recursive_aggregate_for_zktube(
            tree_depth, 
            num_inputs, 
            &vks, 
            &proofs_to_check, 
